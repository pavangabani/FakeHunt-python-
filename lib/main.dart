...
class _DetectMainState extends State<DetectMain> {
  ...
  loadModel() async {
    ...
    try {
      ...
      res = await Tflite.loadModel(
        model: "photo/qmodelv2.tflite",
        labels: "photo/label.txt",
      );
      print(res);
  ...
  Widget printValue(rcg) {
    ...
    return Padding(
      ...
      child: Center(
        child: Text(
          "Confidence of Fake : "+sigmoid(_recognitions[0]['confidence'],1).toString()+"%" ,
...
//    List<Widget> stackChildren = [];
    ...
    return Scaffold(
        appBar: AppBar(
          ...
          title: Text("FakeHunt", style: TextStyle(color: Colors.white),),
